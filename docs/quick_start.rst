...
Download BaxoSite Django Project Boilerplate
--------------------------------------------

First, you need to download the BoilerPlate for GitHub.
...
This project is named *BaxoSite*, so if you are using this 
Boilerplate to create your own project, you'll have to change 
the name in a few places:
 
 - *baxosite_project* **folder** (your top project container)
 - *baxosite_project/baxosite* **folder** (your project name)
 - virtual environment names: **tb_dev** and **tb_test** (name them whatever you want)
 - in virtual environments **postactivate** files (see section below), you have to change **baxosite.settings.development** for your **projectname.settings.development**. Same works for the testing environment.
...
You must add the lines: ::
    ...
    export DJANGO_SETTINGS_MODULE="baxosite.settings.development"
...
where you have to add the lines::
    ...
    export DJANGO_SETTINGS_MODULE="baxosite.settings.testing"
    export SECRET_KEY="your_secret_django_key"
...
.. |internationalization_post| raw:: html
    ...
    <a href="http://marinamele.com/baxosite-django-tutorial/internationalization-localization-languages-time-zones" target="_blank">baxosite post</a>
 
 
Translation
***********
 
Go to the terminal, inside the baxosite_project folder and create the files to translate with::
...
Next, go to the locale folder of your language::
    ...
    $ cd baxosite/locale/ca/LC_MESSAGES
 
where baxosite is your project folder. You have to edit the file *django.po* and translate the strings. You can find more information about how to translate the strings |translation_strings_post|.
 
.. |translation_strings_post| raw:: html
 
    <a href="http://marinamele.com/baxosite-django-tutorial/internationalization-localization-languages-time-zones#inter-translation" target="_blank">here</a>
...
- in **test_internationalization**, update your languages with the translation of title text, here "Welcome to baxosite!"
